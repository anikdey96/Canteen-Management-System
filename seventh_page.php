...
$query = "SELECT * FROM `items` WHERE CONCAT(`id`, `name`, `price`, `deleted`) LIKE '%".$valueTosearch."%' && not deleted && id = 21";


$search_result1 = filterTable1($query);
}
else{
$query = "SELECT * FROM `items` where not deleted && id = 21";
$search_result1 = filterTable1($query);
}
...
{
$valueTosearch = $_POST['valueTosearch'];
$query = "SELECT * FROM `items` WHERE CONCAT(`id`, `name`, `price`, `deleted`) LIKE '%".$valueTosearch."%' && not deleted && id = 22";


$search_result2 = filterTable2($query);
}
else{
$query = "SELECT * FROM `items` where not deleted && id = 22";
$search_result2 = filterTable2($query);
}
...
{
$valueTosearch = $_POST['valueTosearch'];
$query = "SELECT * FROM `items` WHERE CONCAT(`id`, `name`, `price`, `deleted`) LIKE '%".$valueTosearch."%' && not deleted && id = 25";


$search_result3 = filterTable3($query);
}
else{
$query = "SELECT * FROM `items` where not deleted && id = 25";
$search_result3 = filterTable3($query);
}
...
@media only screen and (max-width: 300px) {
  .prev, .next,.text {font-size: 11px}
    ...
    <body>
        <!-- <img src="images/food.png" alt="Special Food"width="200" height="200"> -->
...
function showSlides(n) {
  ...
  <nav>
      <ul>
         ...
         <li><a href="seventh_page(2).html">Add</a></li>  -->
         ...
         <!-- <li><a href="admin3.html">Add</a></li> -->
       </ul>
     </nav>
     <form action="seventh_page.php" method="post">
...
<br>
<div id="igh" style="background-color:lightblue">
  <p id="gh">&copy;Jashore University of Science & Technology</p>
