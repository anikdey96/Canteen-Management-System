...
<div class="section">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Copyright © 2019 <a class="grey-text text-lighten-4" href="#" target="_blank">JASHORE</a> UNIVERSITY OF SCIENCE & TECHNOLOGY </span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">ANIK DEY JOY</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
